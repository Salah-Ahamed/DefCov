...
export default class shallowbreath extends  React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <div class="chbackground">
        ...
        <h1 class="ch1line1">Record your SHALLOW BREATH</h1>
        ...
        backgroundColor="#FFFFFF"></AudioAnalyser></div>
            ...
            <Link to="/Shallowcough"><button className="rebtn4" onClick={handleSubmit}><b/>Upload</button></Link>
...
/**<button onClick={this.fmtMSS(count)}><b/>Start</button> */
